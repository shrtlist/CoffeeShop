        ...
        for mapItem in response.mapItems {
            if let name = mapItem.name,
               ...
               let postalAddress = mapItem.placemark.postalAddress {
                ...
                let yelpBusiness = YelpBusiness(id: mapItem.id, name: name, imageUrl: url.absoluteString, url: url.absoluteString, reviewCount: 0, rating: 0.0, price: nil, location: location, phone: phone)
